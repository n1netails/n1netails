...
import com.n1ne.n1netails.api.repository.UserRepository;
import com.n1ne.n1netails.api.service.LoginAttemptService;
...
import static com.n1ne.n1netails.api.model.enumeration.Role.ROLE_USER;
...
//        user.setProfileImageUrl(getTemporaryProfileImageUrl(newUser.getUsername()));
        userRepository.save(user);
        log.info("new user password: " + newUser.getPassword());
        return user;
    }
