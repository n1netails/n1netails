...
//            List<NotificationPlatform> platforms
    ) {
...
//        this.platformHandlers = platforms.stream()
//                .collect(Collectors.toMap(
//                        NotificationPlatform::getPlatformName,
//                        p -> p
//                ));
    ...
    public void sendNotificationAlert(UsersEntity usersEntity, KudaTailRequest request, Long tokenId) throws Exception {
        ...
        Map<String, Boolean> platformEnabledFlags = Map.of(
...
//            NotificationPlatform handler = platformHandlers.get(platform);
...
//            } catch (Exception e) {
//                throw new NotificationException("Failed sending notification via " + platform, e);
//            }
        }
    }
...
//                    case DISCORD -> {
////                        try {
//                            if (discordEnabled) self.runDiscordWebhookClient(request, config);
...
//    )
//    public void runDiscordWebhookClient(KudaTailRequest request, NotificationConfigEntity configEntity) {
//        try {
...
//        } catch (DiscordWebhookException e) {
//            throw new  DiscordWebhookException(e.getMessage(), e);
//        }
//    }
//
//    @Recover
//    public void recoverDiscordWebhookClient(DiscordWebhookException e, KudaTailRequest request, NotificationConfigEntity configEntity) {
//        throw new NotificationException("There was an issue sending a notification to Discord");
//    }
//
