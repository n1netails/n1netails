  ...
  startTutorial() {
    ...
    this.shepherdService.addSteps([
      ...
      },
      {
        ...
        text: [
          'These preferences can be used to set what type of notifications you want to send and will override any n1ne token settings. Choose your preferred notification methods and click "Save Preferences".',
        ],
        attachTo: {
      ...
      },
      {
        ...
        text: [
          'Provide a name for your new token. For example you can create a test token called `notification-test-token`.',
        ],
        attachTo: {
      ...
      },
      {
        ...
        text: [
          'Select the organization this token is associated with. Select the n1netails organization if this is token is for you.',
        ],
        attachTo: {
      ...
      },
      {
        ...
        text: [
          'This is the Notification Manager. Click “Manage” under Settings → Active Tokens to open the Token Notification Manager. Here, you can configure which platforms each token is allowed to send notifications to. (If you haven’t created a n1ne token yet, please do so before continuing.)',
        ],
        attachTo: {
          element:
            '.ant-table-tbody > tr:first-child > td:nth-child(9) > button, [data-tutorial-id="notification-manager"]',
          on: 'right',
        },
        buttons: [
          {
      ...
      },
      {
        ...
        text: [
          'You can enable token notifications for Email, Microsoft Teams, Slack, Discord, and Telegram in the Token Notification Manager.',
        ],
        attachTo: {
      ...
      },
      {
        ...
        title: 'How to Create...',
        text: [
          'If you want to learn more about how to create a notification channel, click on the "How to create..." links provided by the Token Notification Manager. You can also learn more about how to configure them in the <a href="https://n1netails.com" target="_blank">N1netails Doc</a>',
        ],
        attachTo: {
      ...
      },
      {
        ...
        text: [
          'Send your first manual notification by pressing the "Add" button. Now you know how to send manual notifications. Don\'t forget you can use the N1ne tokens to configure where you want to send your notifications to.',
        ],
        buttons: [
          {
            classes: 'shepherd-button-primary',
